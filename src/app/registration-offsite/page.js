...
function RegistrationOffsite() {
  ...
  const [postCallMutation, { data: printData }] = usePostCallWithAuthMutation();
  ...
  const handleFormSubmit = async (event) => {
    ...
    if (
      ...
      let body = {
        ...
        amount: isIndian ? (isCodeValid ? 2000 : 3000) : 118,
        tax: isIndian ? (isCodeValid ? 360 : 540) : 18,
        membership_code: delegateCode,
      };
...
export default RegistrationOffsite;
