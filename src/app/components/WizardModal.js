...
function WizardModal({ heading, subHeading, description }) {
  ...
  return (
    <div>
      <Modal
        ...
        className={`bg-white h-screen w-[35%] absolute right-0 shadow-2xl p-4 transition-all ${
        ...
        <>
          <div className="MODAL-BODY h-full">
            <div className="h-full flex flex-col">
              ...
              <p className="text-[#5a5a5a] py-6">{description}</p>
